...
var COMPOSEUR_REGLES = [
  ...
  {
    // TACHE (audit robustesse, 2026-09-11) : renumerotee R005 -> R007 --
    // collision de numero trouvee avec COMPOSEUR_REGLE_R005
    // (composeurStrategies.js, une regle differente : selection de la
    // strategie de presentation). Meme cle/logique, juste le numero
    // change.
    numero: 'R007', categorie: 'preferee',
    ...
    appliquer: function (profil) {
      ...
      return { valeur: echelle, regle: 'R007' };
    }
  },
  {

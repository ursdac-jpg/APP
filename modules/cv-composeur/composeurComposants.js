...
var COMPOSEUR_REGISTRE_COMPOSANTS = {
  ...
  // simple liste de mots, même profil que 'competences'/'langues' -- va donc
  // aussi bien en colonne principale (thèmes 1 colonne) qu'en colonne latérale
  // (thèmes 2 colonnes). Enregistrée ici surtout pour que
  // composeurRubriqueCompatibleColonne('logiciels', 'laterale') réponde vrai
  // (sinon composeurComposition.js ne pousserait jamais 'logiciels' en latérale).
  logiciels: {
    liste: {
      id: 'liste', rubrique: 'logiciels', colonnesCompatibles: ['principale', 'laterale'],
      hauteurLignesEstimee: function (objetCV) { return (objetCV.logiciels || []).length; }
    }
  },
  loisirsEngagements: {
    liste: {

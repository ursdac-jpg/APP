...
var STRATEGIES_CV = [
  {
    ...
    // 'logiciels' inséré juste après 'competences' dans les 3 stratégies --
    // les logiciels maîtrisés (dossier.logiciels) étaient saisis et transmis
    // à l'assistant lettre/entretien mais n'apparaissaient sur aucun CV.
    // Colonne latérale (thème 2 colonnes) ou colonne principale (thèmes 1
    // colonne), toujours après les compétences, avant les langues.
    ordreRubriques: ['enTete', 'profil', 'experiences', 'formations', 'competences', 'logiciels', 'loisirsEngagements', 'competencesPersonnelles'],
  ...
  },
  {
    ...
    ordreRubriques: ['enTete', 'profil', 'competencesCles', 'logiciels', 'experiences', 'formations', 'loisirsEngagements', 'competencesPersonnelles'],
  ...
  },
  {
    ...
    // TACHE (retour utilisateur : "je n'ai pas du tout la rubrique
    // loisirs" -- bug réel trouvé) : 'loisirsEngagements' manquait ici,
    // contrairement aux 2 autres stratégies -- "Centre d'intérêt"
    // disparaissait entièrement dès que cette stratégie était choisie,
    // jamais signalé avant aujourd'hui. Ajouté à la même place que dans
    // 'chronologique'/'mixte' (juste avant 'competencesPersonnelles').
    ordreRubriques: ['enTete', 'profil', 'competences', 'logiciels', 'experiences', 'formations', 'loisirsEngagements', 'competencesPersonnelles'],

/* ============================================================
   ...
   réponse de raffinement est une réponse de l’assistant comme une autre, elle
...
// Parse la réponse de l’assistant d'un tour de raffinement -- même discipline que
...
// redemander à l’assistant), avec un compteur de raffinement remis à zéro (un
...
// ou `module` n'est jamais defini). _decouverteTransitionner et
// initialiserEtatFragment sont autonomes (aucune dependance externe) ;
// validerFragment/declencherRaffinement/analyserReponseRaffinement ne
// sont pas exportees ici (dependent de construireCompetence/
// competenceEstValide/decouverteValiderCategorie -- hors perimetre de
// ce test cible sur la machine a etats elle-meme).
if (typeof module !== 'undefined') {
  module.exports = {
    DECOUVERTE_ETATS_FRAGMENT: DECOUVERTE_ETATS_FRAGMENT,
    _decouverteTransitionner: _decouverteTransitionner,
    initialiserEtatFragment: initialiserEtatFragment
  };
}

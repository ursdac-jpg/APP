...
// à...", etc. -- quelle que soit la categorie assignée par l’assistant.
...
function mapperFragmentsVersDossier(fragmentsValides, infosComplementairesParFragment) {
  ...
  var misesAJour = {
    ...
    // compétences personnelles proposées par l’assistant classique (cv.md) --
  ...
  (fragmentsValides || []).forEach(function (etatFragment) {
    ...
    (etatFragment.competencesValidees || []).forEach(function (competence) {
      ...
      // categorie assignée par l’assistant -- jamais un nom d'activité.
...
function appliquerMisesAJourDossier(dossierCible, misesAJour) {
  ...
  ['loisirs', 'engagements'].forEach(function (champ) {
    ...
    // déjà corrigée (jamais à la place) -- si l’assistant crée malgré tout un
  ...
  // recommandations.competencesPersonnelles (celui-là vient de l’assistant
...
// Export CommonJS protege -- tests/decouverteMappingLogique.test.js
// (Node), aucun effet sur le chargement navigateur classique (balise
// <script>, ou `module` n'est jamais defini). DECOUVERTE_CATEGORIES et
// DECOUVERTE_ETATS_FRAGMENT sont des dependances externes (respectivement
// decouverteClassification.js et decouverteRaffinement.js) : a fournir
// par le test via `global` avant le require, meme principe que
// decouverteLogique.test.js.
if (typeof module !== 'undefined') {
  module.exports = {
    mapperFragmentsVersDossier: mapperFragmentsVersDossier,
    appliquerMisesAJourDossier: appliquerMisesAJourDossier,
    _decouverteRessembleADisposition: _decouverteRessembleADisposition,
    _decouvertePreuvesProches: _decouvertePreuvesProches,
    _decouverteConcatenerPreuve: _decouverteConcatenerPreuve,
    _decouverteDedupliquerSousEnsembles: _decouverteDedupliquerSousEnsembles
  };
}

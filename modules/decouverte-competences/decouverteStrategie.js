...
// ou `module` n'est jamais defini). determinerTypeCV/calculerScoresStrategies
// sont entierement pures et autonomes ; proposerStrategie n'est pas
// exportee ici (depend de rechercherMetiers/categorieCompetence/correspond,
// tout le referentiel metiers -- hors perimetre de ce test cible).
if (typeof module !== 'undefined') {
  module.exports = {
    determinerTypeCV: determinerTypeCV,
    calculerScoresStrategies: calculerScoresStrategies
  };
}

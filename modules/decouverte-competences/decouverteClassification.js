...
function construireCompetence(params) {
  ...
  return {
    ...
    // Le texte retenu -- soit une formulation proposée par l’assistant et
    ...
    // s'il vient d'une formulation proposée par l’assistant et choisie.
...
// ou `module` n'est jamais defini). Fichier deja entierement pur.
if (typeof module !== 'undefined') {
  module.exports = {
    DECOUVERTE_CATEGORIES: DECOUVERTE_CATEGORIES,
    DECOUVERTE_ORIGINES: DECOUVERTE_ORIGINES,
    DECOUVERTE_TYPES_CV: DECOUVERTE_TYPES_CV,
    construireCompetence: construireCompetence,
    competenceEstValide: competenceEstValide
  };
}

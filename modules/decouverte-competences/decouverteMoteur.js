...
// Export CommonJS protege -- tests/decouverteMoteurLogique.test.js
// (Node), aucun effet sur le chargement navigateur classique (balise
// <script>, ou `module` n'est jamais defini). Ce fichier n'a pas de
// logique metier propre (voir l'entete) : les tests portent sur le
// comportement d'orchestration lui-meme (tracage, catch centralise),
// pas sur les modules encapsules -- fournis par le test via `global`
// avant le require, sous forme de fonctions de test controlees.
if (typeof module !== 'undefined') {
  module.exports = {
    obtenirJournalExecutionDecouverte: obtenirJournalExecutionDecouverte,
    _decouverteReinitialiserJournal: _decouverteReinitialiserJournal,
    executerAnalyseInitiale: executerAnalyseInitiale,
    executerRaffinement: executerRaffinement,
    executerValidationFragment: executerValidationFragment,
    executerStrategie: executerStrategie,
    executerMapping: executerMapping,
    executerApplicationDossier: executerApplicationDossier,
    demarrerDecouverteCompetences: demarrerDecouverteCompetences
  };
}

...
// TACHE (retour utilisateur : "le bleu marine, il est tout le temps
// utilisé dans les CV -- j'aimerais bien l'avoir parmi les couleurs
// raccourcies") : 1 nouvelle base ajoutée ici, même principe purement
// additif que les 4 précédentes (rose/marron/gris/turquoise) -- ses 10
// nuances sont générées automatiquement, jamais calculées à la main.
// Distinct de "bleu" (plus vif, #2563EB) et de "noir" (quasi neutre,
// #18181B) -- un vrai bleu marine reconnaissable, pas une simple variante
// sombre de l'un ou de l'autre.
var PALETTES_COULEURS_CV_BASE = {
  ...
  bleuMarine: { nom: 'Bleu marine', hex: '1F3864' }
};
var ORDRE_COULEURS_CV = ['bleu', 'vert', 'orange', 'rouge', 'violet', 'noir', 'rose', 'marron', 'gris', 'turquoise', 'bleuMarine'];

...
**Mode de référence :** metier

**CV de la personne (déjà anonymisé) :**
Secrétaire dans un cabinet médical, 2019 à 2023. Je recevais les patients à leur arrivée, je prenais les rendez-vous par téléphone et sur l'ordinateur, je tenais l'agenda des trois médecins, je classais les dossiers et j'encaissais les consultations. Avant, vendeuse en boulangerie pendant deux ans : vente, rendu de monnaie, mise en place de la vitrine.

**Métier visé :** Agent d'accueil

**Code ROME de la fiche métier (mode metier) :** M1601

**Amorce de vocabulaire de la fiche métier (mode metier) :** Bureautique, Gestion administrative, Conseil, Accueil, Communication, Écoute, Patience, Sens du service, Standard téléphonique, Procédures d'accueil

**Offre d'emploi (mode offre) :** Non fournie

**Entreprise ciblée :** Non fournie

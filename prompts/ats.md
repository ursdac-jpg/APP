...
**Mode de référence :** {MODE_REFERENCE}
...
**Code ROME de la fiche métier (mode metier) :** {CODE_ROME}

**Amorce de vocabulaire de la fiche métier (mode metier) :** {VOCABULAIRE_FICHE_METIER}

**Offre d'emploi (mode offre) :** {OFFRE_EMPLOI_OU_NON_FOURNIE}
